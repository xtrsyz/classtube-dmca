...
<title>Index of <?php echo str_replace('\\', '', dirname(strip_tags($_SERVER['PHP_SELF']))).$leadon;?></title>
...
/* 728x15, created 6/28/09 mig33 */
google_ad_slot = "9661623025";
google_ad_width = 728;
google_ad_height = 15;
//-->
...
<div id="container">
  <h1>Index of <?php echo str_replace('\\', '', dirname(strip_tags($_SERVER['PHP_SELF']))).$leadon;?></h1>
...
<script type="text/javascript"><!--
google_ad_client = "pub-3709515531962980";
/* 728x90, created 1/5/10 phpbb avalon */
google_ad_slot = "7188562218";
google_ad_width = 728;
google_ad_height = 90;
//-->
</script>
...
<div id="copy">&copy; 2009 xtrsyz, <a href="http://xtrsyz.org/">Dr.XT</a>.</div>
</body>
</html>
